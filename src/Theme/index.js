...
const theme = (darkMode, color) => ({
  ...
  // uniswapPink: darkMode ? '#E24E1B' : 'black',
  ...
  //primary colors
  primary1: darkMode ? '#2172E5' : '#E24E1B',
  ...
  // color text
  primaryText1: darkMode ? '#6da8ff' : '#E24E1B',

  // secondary colors
  secondary1: darkMode ? '#2172E5' : '#E24E1B',
  ...
  background: darkMode ? 'black' : `radial-gradient(50% 50% at 50% 50%, #E24E1B 30 0%, #fff 0%)`,
})
